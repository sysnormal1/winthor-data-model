...
public class PcCnaeSpecs {

    public static Specification<PcCnae> normalizedCodCnaeEquals(String codCnae) {
        String onlyDigits = TextUtils.onlyDigitsLeftTrim(codCnae);
